...
height = 80.0
output_file = "fit_energy_difference"
...
# Chemical equilibria chosen: none
mu_Na = 0
mu_O = 0
#############################################################################################################################
...
with PdfPages(output_file+".pdf") as output:
    ...
    axs[0, 0].text(0.90, 0.85, "a", transform=axs[0, 0].transAxes)
    axs[0, 1].text(0.90, 0.85, "b", transform=axs[0, 1].transAxes)
    axs[1, 0].text(0.90, 0.85, "c", transform=axs[1, 0].transAxes)
    axs[1, 1].text(0.90, 0.85, "d", transform=axs[1, 1].transAxes)
